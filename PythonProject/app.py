...
from auth import auth_bp, init_oauth  # Import init_oauth
...
# Initialize OAuth
init_oauth(app)  # ADD THIS LINE

# ... rest of app.py ...

# ✅ ВАЖНО: Създаване на таблиците, ако не съществуват
...
def not_found_error(error):
    # Временно използвай прост текст, докато създадеш 404.html
